...
<!-- action="./php/usuario_guardar.php" donde enviaremos el formulario
 method="POST" metodo de envio 
 autocomplete="off" auticompletado desactivado desativa auntompletado del navegador
 class="FormularioAjax" enviar formulario ajax  -->
